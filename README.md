...
| [Substack: Auto-close the subscribe and sign-in popups](sites/substack.com/close-popups.user.js) | [doc](sites/substack.com/close-popups.md) |  | Closes the "Discover more from" subscribe popup that covers a post, and stops the browser's sign-in bubble from appearing at all. |
