...
| [Substack: Auto-close the subscribe, referral, and sign-in popups](sites/substack.com/close-popups.user.js) | [doc](sites/substack.com/close-popups.md) | [GF](https://greasyfork.org/scripts/594856-substack-auto-close-the-subscribe-referral-and-sign-in-popups) | Closes the "Discover more from" subscribe popup and the "shared this with you" referral popup that cover a post, and stops the browser's sign-in bubble from appearing at all. |
