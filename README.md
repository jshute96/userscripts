...
| [Garmin Connect → Strava: Upload new activities with one click](sites/connect.garmin.com/upload-to-strava.user.js) | [doc](sites/connect.garmin.com/upload-to-strava.md) | [GF](https://greasyfork.org/scripts/594858-garmin-connect-strava-upload-new-activities-with-one-click) | Adds an Upload to Strava button to Garmin's toolbar and an Upload from Garmin item to Strava's upload menu. Either sends all new rides you haven't uploaded yet. |
...
| [Instagram: Fullscreen images and video, video seek bar, keyboard shortcuts](sites/instagram.com/fullscreen-and-keyboard.user.js) | [doc](sites/instagram.com/fullscreen-and-keyboard.md) |  | View images and videos full screen, add a progress bar on videos, and add keyboard shortcuts to step through posts |
| [Google Maps: Correct names: Lake Ontario & Gulf of Mexico](sites/maps.google.com/correct-names.user.js) | [doc](sites/maps.google.com/correct-names.md) | [GF](https://greasyfork.org/scripts/594854-google-maps-correct-names-lake-ontario-gulf-of-mexico) | Google shows wrong place names for US users. Use the correct labels the rest of the world sees. |
...
| [Pinkbike: Auto-close the floating footer ads](sites/pinkbike.com/close-sticky-footer-ad.user.js) | [doc](sites/pinkbike.com/close-sticky-footer-ad.md) | [GF](https://greasyfork.org/scripts/591541-pinkbike-auto-close-the-floating-footer-ads) | Stops the sticky ad banners that cover article text at the bottom of the page from ever sliding in, and closes any that still appear. |
...
| [Strava: Rescale segment my-efforts graph to handle outliers better](sites/strava.com/rescale-recent-efforts.user.js) | [doc](sites/strava.com/rescale-recent-efforts.md) | [GF](https://greasyfork.org/scripts/594855-strava-rescale-segment-my-efforts-graph-to-handle-outliers-better) | Strava's Recent Efforts graph scales its y-axis (time) to include your slowest ride. Rescale the graph so a few slow outliers don't flatten everything else. |
| [Strava: Show multiple rank summaries on segment leaderboard pane](sites/strava.com/segment-leaderboard-ranks.user.js) | [doc](sites/strava.com/segment-leaderboard-ranks.md) |  | Enhances the segment leaderboard to show the ranks for multiple dimensions all at once, computes a rank for My Results, and adds month and week views. |
...
| [Strava Upload: One-click defaults for my preferred commute settings](sites/strava.com/upload-commute-preset.user.js) | [doc](sites/strava.com/upload-commute-preset.md) |  | Adds a Set button beside the Commute tag on the upload page that titles the activity, tags it as a commute, sets my usual bike, and makes it private. |
| [Substack: Auto-close the subscribe, referral, and sign-in popups](sites/substack.com/close-popups.user.js) | [doc](sites/substack.com/close-popups.md) | [GF](https://greasyfork.org/scripts/594856-substack-auto-close-the-subscribe-referral-and-sign-in-popups) | Closes the "Discover more from" subscribe popup, the "shared this with you" referral popup, and the full-page welcome interstitial, and stops the browser's sign-in bubble from appearing at all. |
...
| [YouTube: Simple zoom and pan](sites/www.youtube.com/zoom-pan.user.js) | [doc](sites/www.youtube.com/zoom-pan.md) | [GF](https://greasyfork.org/scripts/596511-youtube-simple-zoom-and-pan) | Zoom and pan the video with the mouse, trackpad or keyboard. Drag a box and zoom to that region. Zoom Shorts to full width. |
...
| Script | Doc | GF | Description |
| --- | --- | --- | --- |
| [Medium: Keyboard comment navigation](sites/medium.com/keyboard-comment-navigation.user.js) | [doc](sites/medium.com/keyboard-comment-navigation.md) | [GF](https://greasyfork.org/scripts/595304-medium-keyboard-comment-navigation) | Adds keyboard shortcuts for moving through the responses on a story — next and previous response, parent, next thread, and open or jump to the responses drawer. |
...
| [The Athletic: Keyboard comment navigation](sites/nytimes.com/athletic-keyboard-comment-navigation.user.js) | [doc](sites/nytimes.com/athletic-keyboard-comment-navigation.md) | [GF](https://greasyfork.org/scripts/592206-the-athletic-keyboard-comment-navigation) | Adds keyboard shortcuts for moving through the comments on an article — next and previous comment, parent, next thread, and jump to the comments section. |
| [NYTimes: Keyboard comment navigation](sites/nytimes.com/keyboard-comment-navigation.user.js) | [doc](sites/nytimes.com/keyboard-comment-navigation.md) | [GF](https://greasyfork.org/scripts/592199-nytimes-keyboard-comment-navigation) | Adds keyboard shortcuts for moving through the comments panel on an article — next and previous comment, parent, next thread, and open or jump to the panel. |
...
| [Reddit: Keyboard comment navigation](sites/reddit.com/keyboard-comment-navigation.user.js) | [doc](sites/reddit.com/keyboard-comment-navigation.md) | [GF](https://greasyfork.org/scripts/592205-reddit-keyboard-comment-navigation) | Adds keyboard shortcuts for moving through the comments on a post — next and previous comment, parent, next thread — taking over reddit's own j/k. |
| [Substack: Keyboard comment navigation](sites/substack.com/keyboard-comment-navigation.user.js) | [doc](sites/substack.com/keyboard-comment-navigation.md) | [GF](https://greasyfork.org/scripts/594859-substack-keyboard-comment-navigation) | Adds keyboard shortcuts for moving through the comments on a post — next and previous comment, parent, next thread, and jump to the comments section. |
| [The Atlantic: Keyboard comment navigation](sites/theatlantic.com/keyboard-comment-navigation.user.js) | [doc](sites/theatlantic.com/keyboard-comment-navigation.md) | [GF](https://greasyfork.org/scripts/592204-the-atlantic-keyboard-comment-navigation) | Adds keyboard shortcuts for moving through the discussion drawer on an article — next and previous comment, parent, next thread, and open or jump to the drawer. |
| [The Verge: Keyboard comment navigation](sites/theverge.com/keyboard-comment-navigation.user.js) | [doc](sites/theverge.com/keyboard-comment-navigation.md) | [GF](https://greasyfork.org/scripts/592203-the-verge-keyboard-comment-navigation) | Adds keyboard shortcuts for moving through an article's comments drawer — next and previous comment, parent, next thread. Also closes the pill that obscures comments. |
| [Washington Post: Keyboard comment navigation](sites/washingtonpost.com/keyboard-comment-navigation.user.js) | [doc](sites/washingtonpost.com/keyboard-comment-navigation.md) | [GF](https://greasyfork.org/scripts/592202-washington-post-keyboard-comment-navigation) | Adds keyboard shortcuts for moving through the comments drawer on an article — next and previous comment, parent, next thread, and open or jump to the drawer. |
...
| --- | --- | --- | --- |
| [image-zoom-pan.js](lib/image-zoom-pan.js) | [doc](lib/image-zoom-pan.md) |  | Shared mouse-wheel, trackpad, drag, and keyboard zoom-and-pan helper for image viewers. |
