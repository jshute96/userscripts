...
| [Google Maps: Correct names: Lake Ontario & Gulf of Mexico](sites/maps.google.com/correct-names.user.js) | [doc](sites/maps.google.com/correct-names.md) |  | Google shows wrong place names for US users. Use the correct labels the rest of the world sees. |
...
| [Strava: Rescale segment my-efforts graph to handle outliers better](sites/strava.com/rescale-recent-efforts.user.js) | [doc](sites/strava.com/rescale-recent-efforts.md) |  | Strava's Recent Efforts graph scales its y-axis (time) to include your slowest ride. Rescale the graph so a few slow outliers don't flatten everything else. |
...
| [Substack: Auto-close the subscribe, referral, and sign-in popups](sites/substack.com/close-popups.user.js) | [doc](sites/substack.com/close-popups.md) |  | Closes the "Discover more from" subscribe popup and the "shared this with you" referral popup that cover a post, and stops the browser's sign-in bubble from appearing at all. |
...
| [Trailforks Map: Show star rating in trail popups](sites/www.trailforks.com/map-popup-star-rating.user.js) | [doc](sites/www.trailforks.com/map-popup-star-rating.md) |  | The trail summary popup on maps lists several things, but leaves out the star rating. This adds it. |
...
| [Substack: Keyboard comment navigation](sites/substack.com/keyboard-comment-navigation.user.js) | [doc](sites/substack.com/keyboard-comment-navigation.md) |  | Adds keyboard shortcuts for moving through the comments on a post — next and previous comment, parent, next thread, and jump to the comments section. |
