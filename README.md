...
| Script | Doc | GF | Description |
| --- | --- | --- | --- |
| [Medium: Keyboard comment navigation](sites/medium.com/keyboard-comment-navigation.user.js) | [doc](sites/medium.com/keyboard-comment-navigation.md) |  | Adds keyboard shortcuts for moving through the responses on a story — next and previous response, parent, next thread, and open or jump to the responses drawer. |
