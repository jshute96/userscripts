...
// @version      0.1.4
// @description  Adds a toolbar button that opens the Activities list and Strava's upload page together — the two pages you need side by side when moving rides to Strava.
